...
<html>
		  	...
		  	$.ajax({
					...
					success: function(result){
						if(result=="true"){
							...
							$("#cnameSpan").html("<font color='green'><b>该课程可以开设</b></font>");
							}
						}
					}
				})
  ...
  <div class="row row-centered"> 
    ...
    <h2>添加课程</h2>
    <form class="form-horizontal" method="post" action="cou/addCou" name="addCou" id="addCou" onsubmit="return false;">
  		<div class="form-group has-feedback">
    			<label for="cname" class="control-label col-md-3">课程名称：</label>
                <div class="col-md-6"> 
